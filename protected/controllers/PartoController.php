...
class PartoController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Parto']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->idparto));
		}
	 ...
	 * @param Parto $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='parto-form')
		{
