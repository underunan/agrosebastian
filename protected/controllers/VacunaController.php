...
class VacunaController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Vacuna'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->idvacuna));
		}
	 ...
	 * @param Vacuna $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='vacuna-form')
		{
